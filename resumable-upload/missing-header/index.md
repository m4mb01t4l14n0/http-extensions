# Editor's drafts for resumable-upload/missing-header branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/missing-header)
